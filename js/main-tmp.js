...
function Page_OnResize(imagesPath)
{
	...
	if (banner)
	{
		...
		if (w>=721)
		{
			banner.innerHTML = "<div style=\"z-index:1000; background-image:url(" + imagesPath + "banner/1920L.png); height:480px; background-repeat:no-repeat; background-attachment:scroll; background-clip: border-box; background-origin:padding-box; background-position-x:center; background-size:auto auto; display:block; box-sizing:inherit;\"></div>";
		}
		if (w<=1080)
		{
